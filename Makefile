...
SOURCES += $(SRC_DIR)/main.mm $(SRC_DIR)/audio_input.mm
...
CXXFLAGS = -std=c++11 -I$(IMGUI_DIR) -I$(IMGUI_DIR)/backends -I$(KISSFFT_DIR) -I/usr/local/include -I/opt/homebrew/include -I/opt/local/include
...
$(BUILD_DIR)/%.o: $(KISSFFT_DIR)/kiss_fft.c
	$(CXX) $(CXXFLAGS) -c -o $@ $<
