...
int app_main(int, char**)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (!is_minimized)
        {
            wd->ClearValue.color.float32[0] = clear_color[0];
            wd->ClearValue.color.float32[1] = clear_color[1];
            wd->ClearValue.color.float32[2] = clear_color[2];
            wd->ClearValue.color.float32[3] = clear_color[3];
